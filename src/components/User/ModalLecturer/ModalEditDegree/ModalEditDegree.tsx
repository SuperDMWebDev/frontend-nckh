                                ...
                                <div style={{ marginBottom: "2px" }} key={degree.id.toString()}>
                                    <p className='data_content' style={{ marginBottom: "-5px" }}>
                                        <div className="card_book">
                                            {canEdit ? <div className='btn-edit-card' onClick={() => handleEditCard(degree)}><ModeEditOutlineIcon /></div>
                                                : null}
                                            <div className="name-book">
                                                <p className="name">Tên đề tài, luận án: {degree.graduationThesisName}</p>
                                            </div>
                                            <div className="user-field">Chuyên ngành: {degree.specialization} - {degree.universityName}</div>
