              ...
              <div style={{ marginBottom: '2px' }} key={workPosition.id.toString()}>
                <p className="data_content" style={{ marginBottom: '-5px' }}>
                  <div className="card_book">
                    {canEdit ? (
                      <div className="btn-edit-card" onClick={() => handleEditCard(workPosition)}>
                        <ModeEditOutlineIcon />
                      </div>
                    ) : null}
                    ...
                    <div>
                      ...
                      {!workPosition.position ? (
                        <span style={{ fontStyle: 'italic', fontSize: '13px' }}>Chưa cập nhật</span>
                      ) : (
                        workPosition.position
                      )}
                    </div>
                    <div className="user-field">
                      ...
                      {workPosition.fromDate == null || workPosition.toDate == null ? (
                        <>
                          <span
                            style={{ fontStyle: 'italic', fontSize: '13px', marginLeft: '5px' }}>
                            Chưa cập nhật
                          </span>
                        </>
                      ) : (
