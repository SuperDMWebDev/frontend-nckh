...
export default function Profile() {
    ...
    const [avatar, setAvatar] = useState<string>("https://mdbcdn.b-cdn.net/img/new/avatars/8.webp");
                    ...
                    <div style={{ textAlign: 'left' }}>
                        ...
                        <div>
                            ...
                            <div className="field-profile-info">
                                ...
                                <span style={{ marginLeft: '5px' }}>{lecturer?.dateOfBirth.slice(0, 10)}</span>
                            </div>
                            <div className="field-profile-info">
                                <EmailIcon style={{ fontSize: '20px' }} />
                                <span style={{ marginLeft: '5px' }}>nvu@fit.hcmus.edu.vn</span>
                            </div>
                            <div className="field-profile-info">
                        ...
                        <>
                            ...
                            <div className="content-profile">
                                <div className="main_content">
                                    ...
                                    {lecturer?.workPositions.map((workPosition: workPosition) => (
